<h1><b>Lista de Cierres: <?php echo $nombre_escuela; ?></b></h1>
<table>
    <tr>
        <th>ID</th>
        <th>Trimestre</th>
    ...
    <tr>
        ...
        <td>
            <?php echo $this->Html->link('Notas', array('controller' => 'notas', 'action'=>'add'));?>
...
<?php echo $this->Html->link('Agregar cierre', array('action'=>'add', $id_escuela));?> 
